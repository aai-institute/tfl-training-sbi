# -*- coding: utf-8 -*-
#
# tfl-training-sbi documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = "https://github.com/appliedAI-Initiative/tfl-training-sbi/blob/master"
    if domain != "py":
        return None
    if not info["module"]:
        return None
...
htmlhelp_basename = "tfl-training-sbi_doc"
...
man_pages = [
    ("index", "tfl-training-sbi", "", ["appliedAI TransferLab"], 1)
]
